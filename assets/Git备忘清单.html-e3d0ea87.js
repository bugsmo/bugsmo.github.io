...
Host github.com
  ProxyCommand nc -X 5 -x 127.0.0.1:1080 %h %p
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="另见" tabindex="-1"><a class="header-anchor" href="#另见" aria-hidden="true">#</a> 另见</h2>`,105);function f(_,k){const i=s("ExternalLinkIcon");return l(),r("div",null,[v,g,o,c(" more "),m,e("p",null,[a("本备忘单总结了常用的 "),e("a",h,[a("Git"),d(i)]),a(" 命令行指令，以供快速参考。")]),b,e("p",null,[a("也可以看看："),e("a",x,[a("更多别名"),d(i)])]),p])}const y=t(u,[["render",f],["__file","Git备忘清单.html.vue"]]);export{y as default};
